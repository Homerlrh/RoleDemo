    ...
    public class LoginController : Controller
    {
        ...
        public IActionResult SecurePostArea([FromBody] PostVM postVM)
        {
            ...
            var responseObject = new
            {
                ...
                messageFromServer = $"Hi {userName} from server",
                userId = userId
            };
        ...
        [HttpPost]
        [Route("SecurePostAddition")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        public IActionResult SecurePostAddition([FromBody] MathVM mathVM)
        {
            int result = mathVM.num1 + mathVM.num2;
            var responseObject = new
            {
                num1 = mathVM.num1,
                num2 = mathVM.num2,
